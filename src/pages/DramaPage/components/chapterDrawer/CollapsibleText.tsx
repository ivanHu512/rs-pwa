  ...
  return (
    <div className="relative">
      ...
      {hasMore && !isExpanded && (
        ...
        >
          <div className="bg-gradient-to-r from-[rgba(20,20,20,0.1)] via-[30%] to-[rgba(20,20,20,1)] pl-[40px]">
            <div className="flex items-center bg-[rgba(20,20,20)]">
              <span className="px-[4px] text-white/50">...</span>
              {moreButton || (
